...
def load_png(file_path: str | bytes | PathLike[str] | PathLike[bytes]) -> tuple[list[list[int]], int, int]:
...
def save_png(bitmap: list[list[int]], file_path: str | bytes | PathLike[str] | PathLike[bytes]):
    pixels = []
